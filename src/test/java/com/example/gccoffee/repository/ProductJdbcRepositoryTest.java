...
class ProductJdbcRepositoryTest {
    ...
    static void setup() {
        ...
        embeddedMysql = anEmbeddedMysql(config)
                .addSchema("test-order_mgmt", ScriptResolver.classPathScript("scheme.sql"))
                .start();
    }
    ...
    @Test
    @Order(2)
    @DisplayName("상품을 이름으로 조회할 수 있습니다.")
    void testFindByName() {
    ...
    @Test
    @Order(3)
    @DisplayName("상품을 아이디로 조회할 수 있습니다.")
    void testFindById() {
    ...
    @Test
    @Order(4)
    @DisplayName("상품들을 카테고리로 조회할 수 있습니다.")
